...
mixin _$BusinessCategoryResponse {
  ...
  List<BusinessCategory>? get data => throw _privateConstructorUsedError;
...
abstract class $BusinessCategoryResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({String status, String? message, List<BusinessCategory>? data});
}
...
class _$BusinessCategoryResponseImpl implements _BusinessCategoryResponse {
  const _$BusinessCategoryResponseImpl(
      {this.status = "fail", this.message, final List<BusinessCategory>? data})
      : _data = data;
  ...
  @override
  List<BusinessCategory>? get data {
    final value = _data;
...
abstract class _BusinessCategoryResponse implements BusinessCategoryResponse {
  const factory _BusinessCategoryResponse(
      {final String status,
      final String? message,
      final List<BusinessCategory>? data}) = _$BusinessCategoryResponseImpl;
