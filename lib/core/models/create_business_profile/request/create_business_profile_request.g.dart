...
_CreateBusinessProfileRequest _$CreateBusinessProfileRequestFromJson(
...
Map<String, dynamic> _$CreateBusinessProfileRequestToJson(
  _CreateBusinessProfileRequest instance,
) => <String, dynamic>{
