...
mixin _$Branch {
 ...
 int get id; String get name; String get location; String get staffSize; String get totalAmount; int? get businessId; String? get createdAt;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Branch&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.location, location) || other.location == location)&&(identical(other.staffSize, staffSize) || other.staffSize == staffSize)&&(identical(other.totalAmount, totalAmount) || other.totalAmount == totalAmount)&&(identical(other.businessId, businessId) || other.businessId == businessId)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,location,staffSize,totalAmount,businessId,createdAt);
...
@useResult
$Res call({
 int id, String name, String location, String staffSize, String totalAmount, int? businessId, String? createdAt
});
...
/// Create a copy of Branch
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? location = null,Object? staffSize = null,Object? totalAmount = null,Object? businessId = freezed,Object? createdAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String name,  String location,  String staffSize,  String totalAmount,  int? businessId,  String? createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Branch() when $default != null:
return $default(_that.id,_that.name,_that.location,_that.staffSize,_that.totalAmount,_that.businessId,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String name,  String location,  String staffSize,  String totalAmount,  int? businessId,  String? createdAt)  $default,) {final _that = this;
switch (_that) {
case _Branch():
return $default(_that.id,_that.name,_that.location,_that.staffSize,_that.totalAmount,_that.businessId,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String name,  String location,  String staffSize,  String totalAmount,  int? businessId,  String? createdAt)?  $default,) {final _that = this;
switch (_that) {
case _Branch() when $default != null:
return $default(_that.id,_that.name,_that.location,_that.staffSize,_that.totalAmount,_that.businessId,_that.createdAt);case _:
  return null;
...
class _Branch implements Branch {
  const _Branch({required this.id, required this.name, required this.location, this.staffSize = "0", this.totalAmount = "0", this.businessId, this.createdAt});
  factory _Branch.fromJson(Map<String, dynamic> json) => _$BranchFromJson(json);

@override final  int id;
@override final  String name;
@override final  String location;
@override@JsonKey() final  String staffSize;
...
/// Create a copy of Branch
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? location = null,Object? staffSize = null,Object? totalAmount = null,Object? businessId = freezed,Object? createdAt = freezed,}) {
