...
mixin _$SendNewPhoneResponse {
 ...
 String get status; String? get message; SendNewPhoneData? get data;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SendNewPhoneResponse&&(identical(other.status, status) || other.status == status)&&(identical(other.message, message) || other.message == message)&&(identical(other.data, data) || other.data == data));
}
...
@useResult
$Res call({
 String status, String? message, SendNewPhoneData? data
});
...
$SendNewPhoneDataCopyWith<$Res>? get data {
  ...
  return $SendNewPhoneDataCopyWith<$Res>(_self.data!, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String status,  String? message,  SendNewPhoneData? data)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SendNewPhoneResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String status,  String? message,  SendNewPhoneData? data)  $default,) {final _that = this;
switch (_that) {
case _SendNewPhoneResponse():
return $default(_that.status,_that.message,_that.data);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String status,  String? message,  SendNewPhoneData? data)?  $default,) {final _that = this;
switch (_that) {
case _SendNewPhoneResponse() when $default != null:
return $default(_that.status,_that.message,_that.data);case _:
  return null;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SendNewPhoneResponse&&(identical(other.status, status) || other.status == status)&&(identical(other.message, message) || other.message == message)&&(identical(other.data, data) || other.data == data));
}
...
@override $SendNewPhoneDataCopyWith<$Res>? get data;
