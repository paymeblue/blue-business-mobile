...
class _ProfileService implements ProfileService {
  ...
  Future<UploadAvatarResponse> uploadDisplayPicture(File displayPic) async {
    ...
    final _options = _setStreamType<UploadAvatarResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
  ...
  Future<GetNotificationResponse> getNotificationStatus() async {
    ...
    final _options = _setStreamType<GetNotificationResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<ToggleNotificationResponse> toggleNotificationStatus(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ToggleNotificationResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<GetBusinessFeesResponse> getBusinessFeesResponse() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetBusinessFeesResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<AutoWithdrawalResponse> toggleAutoWithdrawal(
      {required AutoWithdrawalRequest request}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = request;
    final _options = _setStreamType<AutoWithdrawalResponse>(Options(
      method: 'PATCH',
      headers: _headers,
      extra: _extra,
    )
