...
class _TransactionService implements TransactionService {
  ...
  Future<InitiateTransactionResponse> initiateTransaction(
    ...
    final _headers = <String, dynamic>{};
    final _data = request;
    final _options = _setStreamType<InitiateTransactionResponse>(
  ...
  Future<VerifiedReceiverResponse> verifyReceiver(
    ...
    final _headers = <String, dynamic>{};
    final _data = request;
    final _options = _setStreamType<VerifiedReceiverResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/payments/verify',
  ...
  Future<PayResponse> withdraw(WithdrawRequest request) async {
    ...
    final _headers = <String, dynamic>{};
    final _data = request;
    final _options = _setStreamType<PayResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/withdraw',
  ...
  Future<ReceiptResponse> getReceipt(String transactionId) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ReceiptResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/payments/receipt',
  ...
  Future<TransactionDetailResponse> getBillTransactionDetails({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<TransactionDetailResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/${service}/details',
  ...
  Future<PaymentLinkResponse> getPaymentLinkHistory(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<PaymentLinkResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/payment-links',
  ...
  Future<PaymentLinkReceiptResponse> getPaymentLinkReceipt(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<PaymentLinkReceiptResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<GetBeneficiaryResponse> searchBeneficiaries(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetBeneficiaryResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/beneficiaries/index',
  ...
  Future<SetBeneficiaryResponse> deleteBeneficiary(int id) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<SetBeneficiaryResponse>(
  ...
  Future<RecentlyPaidResponse> getRecentlyPaid() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<RecentlyPaidResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<WithdrawalAccountResponse> getWithdrawalAccount() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<WithdrawalAccountResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/settlement-accounts',
  ...
  Future<BankResponse> getBanks() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<BankResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/banks',
  ...
  Future<VerifyPayoutResponse> verifyAccount(
    VerifyPayoutRequest request,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = request;
    final _options = _setStreamType<VerifyPayoutResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<SetPayoutResponse> addPayout(SetPayoutRequest request) async {
    ...
    final _headers = <String, dynamic>{};
    final _data = request;
    final _options = _setStreamType<SetPayoutResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/settlement-accounts',
