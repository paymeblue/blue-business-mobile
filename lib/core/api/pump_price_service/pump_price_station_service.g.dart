...
class _PumpPriceStationService implements PumpPriceStationService {
  _PumpPriceStationService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<GetFillingStationsResponse> getBranches({
    ...
    final _options = _setStreamType<GetFillingStationsResponse>(
  ...
  Future<CreatePumpPriceBranchResponse> createBranch({
    required CreatePumpPriceBranchRequest request,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = request;
    final _options = _setStreamType<CreatePumpPriceBranchResponse>(
  ...
  Future<EditPumpPriceBranchResponse> editBranch({
    ...
    final _headers = <String, dynamic>{};
    final _data = request;
    final _options = _setStreamType<EditPumpPriceBranchResponse>(
  ...
  Future<PumpPriceInsightsResponse> getInsights({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<PumpPriceInsightsResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
