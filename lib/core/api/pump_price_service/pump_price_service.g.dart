...
class _PumpPriceService implements PumpPriceService {
  _PumpPriceService(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
  ...
  @override
  Future<List<FillingStation>> getBranches() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<FillingStation>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late List<FillingStation> _value;
    try {
      _value = _result.data!
          .map(
              (dynamic i) => FillingStation.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
