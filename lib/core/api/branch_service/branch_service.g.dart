...
class _BranchService implements BranchService {
  _BranchService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<GetBranchesResponse> getAllBranches({
    ...
    final _options = _setStreamType<GetBranchesResponse>(
    ...
    late GetBranchesResponse _value;
    try {
      _value = GetBranchesResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<GetBranchResponse> getBranchById({required int id}) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetBranchResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/branches/${id}',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetBranchResponse _value;
    try {
      _value = GetBranchResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<CreateBranchResponse> createBranch({
    ...
    final _headers = <String, dynamic>{};
    final _data = request;
    final _options = _setStreamType<CreateBranchResponse>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CreateBranchResponse _value;
    try {
      _value = CreateBranchResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<SalesAnalyticsResponse> getBranchInsights({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<SalesAnalyticsResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late SalesAnalyticsResponse _value;
    try {
      _value = SalesAnalyticsResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<BranchAnalyticsResponse> getAnalytics({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<BranchAnalyticsResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BranchAnalyticsResponse _value;
    try {
      _value = BranchAnalyticsResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
