...
class _BranchService implements BranchService {
  ...
  Future<GetBranchesResponse> getAllBranches({
    ...
    final _options = _setStreamType<GetBranchesResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<GetBranchResponse> getBranchById({required int id}) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetBranchResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<CreateBranchResponse> createBranch(
    ...
    final _headers = <String, dynamic>{};
    final _data = request;
    final _options = _setStreamType<CreateBranchResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<SalesAnalyticsResponse> getBranchInsights({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<SalesAnalyticsResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<BranchAnalyticsResponse> getAnalytics({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<BranchAnalyticsResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
