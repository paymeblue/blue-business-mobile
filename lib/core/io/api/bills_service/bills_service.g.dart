...
class _BillsService implements BillsService {
  ...
  Future<GetPackagesResponse> getPackages({
    ...
    final _options = _setStreamType<GetPackagesResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<GetProvidersResponse> getProviders(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetProvidersResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<VerifyDataResponse> verifyDataInfo(VerifyDataRequest request) async {
    ...
    final _headers = <String, dynamic>{};
    final _data = request;
    final _options = _setStreamType<VerifyDataResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<VendElectricityResponse> vendElectricity(
    ...
    final _headers = <String, dynamic>{};
    final _data = request;
    final _options = _setStreamType<VendElectricityResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<VendAirtimeResponse> vendAirtime(VendAirtimeRequest request) async {
    ...
    final _headers = <String, dynamic>{};
    final _data = request;
    final _options = _setStreamType<VendAirtimeResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<VendCableResponse> vendCable(VendCableRequest request) async {
    ...
    final _headers = <String, dynamic>{};
    final _data = request;
    final _options = _setStreamType<VendCableResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<VendDataResponse> vendData(VendDataRequest request) async {
    ...
    final _headers = <String, dynamic>{};
    final _data = request;
    final _options = _setStreamType<VendDataResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
