...
class _TransactionService implements TransactionService {
  ...
  @override
  Future<PushPayResponse> acceptPayment(CreditRequest request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = request;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<PushPayResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = PushPayResponse.fromJson(_result.data!);
    return value;
  }
