...
class AppStateManager extends DisposableProvider {
  ...
  bool get canSaveBeneficiary => _canSaveBeneficiary;
  ...
  set conversation(bool v) {
    _conversation = v;
    notifyListeners();
  }

  set changePin(bool v) {
    _changePin = v;
    notifyListeners();
  }
  ...
  set canSaveBeneficiary(bool v) {
    _canSaveBeneficiary = v;
    notifyListeners();
  }
