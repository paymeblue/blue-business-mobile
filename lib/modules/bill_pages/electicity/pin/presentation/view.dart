...
class ConfirmElectricityPinView extends StatefulWidget {
  ...
  @override
  State<ConfirmElectricityPinView> createState() =>
      _ConfirmElectricityPinViewState();
}

class _ConfirmElectricityPinViewState extends State<ConfirmElectricityPinView> {
  @override
          ...
          body: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                confirmButton(
                  onTap: () {
                    model.onButtonTap(context, widget.data, widget.amount);
                  },
    ...
    return Padding(
      ...
      child: NumPad(
        ...
        onUsebiometrics: StorageValues.pin.isNotEmpty
            ? () {
                model.completeWithBiometrics(
                    context, widget.data, widget.amount);
              }
            : null,
      ),
    );
