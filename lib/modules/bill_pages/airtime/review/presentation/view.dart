...
class ReviewAirtimeView extends StatefulWidget {
  final ReviewAirtimeData data;
  const ReviewAirtimeView({super.key, required this.data});

  @override
  State<ReviewAirtimeView> createState() => _ReviewAirtimeViewState();
}

class _ReviewAirtimeViewState extends State<ReviewAirtimeView> {
  @override
          ...
          body: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "${nairaSymbol()}${widget.data.amount.toStringAsFixed(2)}",
                ...
                ...detailsSection(
                  ...
                  detail: widget.data.provider.name,
                ),
                ...detailsSection(
                  title: "Phone number",
                  detail: widget.data.phone,
                ),
                detailRow(
                    title: "Amount",
                    detail: "${nairaSymbol()}${widget.data.amount}"),
                const Spacer(),
                AppButton.primary(
                  title: "Continue",
                  onTap: () {
