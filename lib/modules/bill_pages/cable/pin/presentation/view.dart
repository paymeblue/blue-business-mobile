...
class ConfirmCablePinView extends StatefulWidget {
  ...
  @override
  State<ConfirmCablePinView> createState() => _ConfirmCablePinViewState();
}

class _ConfirmCablePinViewState extends State<ConfirmCablePinView> {
  @override
  ...
  Padding numberPad(ConfirmCablePinViewModel model) {
    return Padding(
