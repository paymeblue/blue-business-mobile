...
class VendCableSuccessView extends StatefulWidget {
  final VendCableData data;
  const VendCableSuccessView({super.key, required this.data});

  @override
  State<VendCableSuccessView> createState() => _VendCableSuccessViewState();
}

class _VendCableSuccessViewState extends State<VendCableSuccessView> {
  @override
