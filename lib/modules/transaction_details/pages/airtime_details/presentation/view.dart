...
import 'package:blue_business/modules/transaction_details/pages/airtime_details/widgets/receipt.dart';
...
class AirtimeDetailsView extends StatefulWidget {
  final AirtimeDetails detail;
  const AirtimeDetailsView({super.key, required this.detail});

  @override
  State<AirtimeDetailsView> createState() => _AirtimeDetailsViewState();
}

class _AirtimeDetailsViewState extends State<AirtimeDetailsView> {
  @override
  Widget build(BuildContext context) {
    return BaseView<AirtimeDetailsViewModel>(
        model: AirtimeDetailsViewModel(),
            ...
            body: Stack(
              children: [
                Screenshot(
                  ...
                  child: AirtimeReceipt(record: widget.detail),
                ),
                Container(
