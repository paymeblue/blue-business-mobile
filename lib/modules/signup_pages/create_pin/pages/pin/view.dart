...
class CreatePinContent extends StatefulWidget {
  final ValueChanged<String> onNewPinSet;
  final int index;
  const CreatePinContent({
    super.key,
  ...
  @override
  State<CreatePinContent> createState() => _CreatePinContentState();
}

class _CreatePinContentState extends State<CreatePinContent> {
  @override
  Widget build(BuildContext context) {
    return BaseView<CreatePinContentViewModel>(
      model: CreatePinContentViewModel(),
        ...
        return Scaffold(
          body: Column(
            ...
            children: [
              ...
              120.verticalGap,
              AppButton.primary(
                title: widget.index == 0 ? "Continue" : "Create PIN",
  ...
  Widget numberPad(CreatePinContentViewModel model) {
    return Padding(
  ...
  Widget pinFields(CreatePinContentViewModel model) {
    return Row(
