...
class CreatePinView extends StatelessWidget {
  ...
  Widget numberPad(CreatePinViewModel model) {
    return Padding(
  ...
  Widget pinFields(CreatePinViewModel model) {
    return Row(
  ...
  List<Widget> newPinTitleAndSubtitle(CreatePinViewModel model) {
    return [
      Text(
        titleString(model),
  ...
  String titleString(CreatePinViewModel model) {
    if (model.isConfirm) {
  ...
  String subtitleString(CreatePinViewModel model) {
    if (model.isConfirm) {
