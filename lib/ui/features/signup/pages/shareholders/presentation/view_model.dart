...
class ShareholderDetailsViewModel extends BaseViewModel {
  ...
  Future<void> init(BuildContext context, SignupData d) async {
  ...
  void goToNext(BuildContext context, {Shareholders? shareholder}) {
    ShareholderKycViewArgs extra = ShareholderKycViewArgs(
      data: data,
