...
class InitiateSignupView extends StatelessWidget {
  const InitiateSignupView({super.key});

  @override
  Widget build(BuildContext context) {
    return BaseView<InitiateSignupViewModel>(
      onModelReady: (model) => model.init(context),
      model: InitiateSignupViewModel(),
  ...
  List<Widget> phoneFieldAndGap(InitiateSignupViewModel model) {
    return [
      BlueTextField.phone(
        title: "Phone",
