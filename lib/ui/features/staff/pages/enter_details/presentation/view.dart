...
class EnterStaffDetailsView extends StatefulWidget {
  final Staff? staff;
  const EnterStaffDetailsView({super.key, this.staff});

  @override
  State<EnterStaffDetailsView> createState() => _EnterStaffDetailsViewState();
}

class _EnterStaffDetailsViewState extends State<EnterStaffDetailsView> {
  @override
  Widget build(BuildContext context) {
    return BaseView<EnterStaffDetailsViewModel>(
      model: EnterStaffDetailsViewModel(),
  ...
  Widget staffTile(EnterStaffDetailsViewModel model) {
    return Container(
  ...
  Widget avatarRow(EnterStaffDetailsViewModel model) {
    return Row(
      children: [
        GestureDetector(
