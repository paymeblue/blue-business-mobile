...
class DeleteAttendantBottomSheet extends StatelessWidget {
  const DeleteAttendantBottomSheet({
    super.key,
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          8.verticalGap,
          Text(
            'Are you sure you want to delete this attendant? This action cannot be undone.',
