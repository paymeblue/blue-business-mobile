...
class BranchHomeViewModel extends BaseViewModel {
  ...
  void onDeleteBranch(BuildContext context, Branch branch) {
    BlueDialog.primary(
      title: "Delete branch",
  ...
  Future<void> deleteBranch(BuildContext context, Branch branch) async {
    AppLoader.start();
  ...
  Future<void> getBranch(BuildContext context, int id) async {
    AppLoader.start();
  ...
  void goToBranchInsights(BuildContext context, Branch branch) {
    locator<AppRouter>().push<bool>(BranchInsightsRoute(branch: branch));
  }

  void goToAddBranch(BuildContext context, [Branch? data]) {
    locator<AppRouter>().push<bool>(EnterBranchDetailsRoute(branch: data)).then(
      (val) {
        if (val == true) {
          branchPagingController.refresh();
        }
